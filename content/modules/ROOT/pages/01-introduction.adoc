...
*Step 5: Explicit Trigger*

You can also invoke skills directly using slash commands:

[source,text]
----
> /example-skills:brand-guidelines check the hero section colors
----
...
You should see the `example-skills` plugin listed, which contains the `brand-guidelines` skill among others.
