...
[source,bash,role="execute"]
----
cat ~/.claude/plugins/cache/anthropic-agent-skills/example-skills/*/skills/skill-creator/SKILL.md
----
...
[source,text]
----
> /example-skills:skill-creator Create a skill called "abstract-writer" that generates
  conference talk abstracts tailored to specific conferences. It should accept a talk
  topic and target conference, produce a compelling abstract with title, summary,
  learning objectives, and target audience. Keep abstracts under 300 words.
----
...
[source,bash,role="execute"]
----
cat ~/.claude/skills/abstract-writer/SKILL.md
----
